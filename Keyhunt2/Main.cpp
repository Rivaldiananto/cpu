...
const char* qstr = "Range end in binary, if not provided then, endRange would be: startRange + 111111                ";
...
int main(int argc, const char* argv[])
{
    ...
    if (rangeStart.length() <= 0) {
        printf("Invalid rangeStart argument, please provide start range at least, endRange would be: startRange + 111111\n");
        exit(-1);
    }
