...
const char* qstr = "Range end in binary, if not provided then, endRange would be: startRange + 10000000000000000     ";
...
int main(int argc, const char* argv[])
{
    ...
    // Konversi rentang biner ke hexadecimal
    ...
    if (SetConsoleCtrlHandler(CtrlHandler, TRUE)) {
        KeyHunt* v = new KeyHunt(hash160File, hash160, searchMode, gpuEnable,
            outputFile, sse, maxFound, hexStart, hexEnd, should_exit);
